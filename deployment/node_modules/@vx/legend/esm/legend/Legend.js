...
Legend.propTypes = {
  ...
  direction: _pt.oneOf(['inherit', 'initial', 'revert', 'unset', 'column', 'column-reverse', 'row', 'row-reverse']),
  itemDirection: _pt.oneOf(['inherit', 'initial', 'revert', 'unset', 'column', 'column-reverse', 'row', 'row-reverse']),
  fill: _pt.func,
  size: _pt.func,
  shape: _pt.any,
  shapeStyle: _pt.func,
  labelFormat: _pt.any,
  labelTransform: _pt.any
};