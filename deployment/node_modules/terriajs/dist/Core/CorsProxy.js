...
export default class CorsProxy {
     ...
     */
    init(serverConfig, baseProxyUrl = CorsProxy.DEFAULT_BASE_PROXY_PATH, proxyDomains = []) {
     ...
     */
    getURLProxyIfNecessary(resource, proxyFlag) {
