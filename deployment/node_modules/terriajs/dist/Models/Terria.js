...
export default class Terria {
    constructor(options = {}) {
        ...
        this.supportEmail = "support@terria.io";
        /**
    ...
    async applyInitData({ initData, replaceStratum = false, canUnsetFeaturePickingState = false }) {
        ...
        const newItems = filterOutUndefined(workbench.map(modelId => {
        ...
        await Promise.all(newItems.map(async (model) => {
            var _a;
            try {
                ...
                errors.push(TerriaError.from(e, {
                    ...
                    message: {
                        ...
                        parameters: {
                            name: (_a = getName(model)) !== null && _a !== void 0 ? _a : "Unknown Model"
                        }
                    }
                }));
            }
    ...
    async loadMagdaConfig(configUrl, config, baseUri) {
        ...
        if (aspects.group && aspects.group.members) {
            ...
            if (existingReference === undefined) {
                ...
                this.addModel(existingReference, (_b = aspects === null || aspects === void 0 ? void 0 : aspects.terria) === null || _b === void 0 ? void 0 : _b.shareKeys);
            }
            ...
            (await reference.loadReference()).raiseError(this, `Failed to load MagdaReference for record ${id}`);
        ...
        this.setupInitializationUrls(baseUri, (_c = config.aspects) === null || _c === void 0 ? void 0 : _c["terria-config"]);
        /** Load up rest of terria catalog if one is inlined in terria-init */
        if ((_d = config.aspects) === null || _d === void 0 ? void 0 : _d["terria-init"]) {
    ...
    if (isDefined(startData) && startData !== {}) {
        ...
        try {
            ...
            if (result.result !== null && Array.isArray(result.result.initSources)) {
                runInAction(() => {
                    terria.initSources.push(...result.result.initSources.map((initSource) => {
                        return {
                            name,
                            data: initSource,
                            errorSeverity
