...
class GpxCatalogItem extends MappableMixin(UrlMixin(CatalogMemberMixin(CreateModel(GpxCatalogItemTraits)))) {
    constructor() {
        super(...arguments);
        this._geoJsonItem = new GeoJsonCatalogItem(createGuid(), this.terria);
    }
    get type() {
    ...
    async forceLoadMapItems() {
        ...
        this._geoJsonItem.setTrait(CommonStrata.definition, "geoJsonData", geoJsonData);
        this._geoJsonItem.setTrait(CommonStrata.definition, "attribution", this.attribution);
