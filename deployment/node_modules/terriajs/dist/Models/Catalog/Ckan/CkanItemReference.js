...
export class CkanDatasetStratum extends LoadableStratum(CkanItemReferenceTraits) {
    ...
    get url() {
        if (this.ckanResource === undefined)
            return undefined;
        if (this.ckanItemReference._supportedFormat !== undefined) {
            if (this.ckanItemReference._supportedFormat.definition.type === "wms" &&
    ...
    get name() {
        if (this.ckanResource === undefined)
            return this.ckanItemReference.name;
        if (this.ckanItemReference.useResourceName)
         ...
         * anything */
        if (this.ckanDataset) {
            if (this.ckanItemReference.useCombinationNameWhereMultipleResources &&
                this.ckanDataset.resources.length > 1) {
                return this.ckanDataset.title + " - " + this.ckanResource.name;
            }
            if (this.ckanItemReference.useDatasetNameAndFormatWhereMultipleResources &&
                this.ckanDataset.resources.length > 1) {
...
CkanDatasetStratum.stratumName = "ckanDataset";
__decorate([
    computed
...
export default class CkanItemReference extends UrlMixin(ReferenceMixin(CreateModel(CkanItemReferenceTraits))) {
    constructor(id, terria, sourceReference, strata) {
        ...
        this._ckanDataset = undefined;
        this._ckanResource = undefined;
        this._ckanCatalogGroup = undefined;
        this._supportedFormat = undefined;
        this.setTrait(CommonStrata.defaults, "supportedResourceFormats", CkanItemReference.defaultSupportedFormats);
    }
    get type() {
    ...
    findFirstValidResource(dataset) {
    ...
    async forceLoadReference(previousTarget) {
        ...
        if (model instanceof WebMapServiceCatalogItem && ((_a = this._ckanResource) === null || _a === void 0 ? void 0 : _a.wms_layer)) {
            model.setTrait(CommonStrata.definition, "layers", this._ckanResource.wms_layer);
        }
...
CkanItemReference.type = "ckan-item";
__decorate([
    computed
