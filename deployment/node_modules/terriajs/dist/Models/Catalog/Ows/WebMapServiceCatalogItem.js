...
class WebMapServiceCatalogItem extends TileErrorHandlerMixin(ExportableMixin(DiffableMixin(TimeFilterMixin(ChartableMixin(GetCapabilitiesMixin(UrlMixin(CatalogMemberMixin(CreateModel(WebMapServiceCatalogItemTraits))))))))) {
    constructor() {
        super(...arguments);
                    ...
                    if (level > maximumLevel) {
                        if (!messageDisplayed) {
                            this.terria.raiseErrorToUser(new TerriaError({
                                title: i18next.t("models.webMapServiceCatalogItem.datasetScaleErrorTitle"),
                                message: i18next.t("models.webMapServiceCatalogItem.datasetScaleErrorMessage", { name: this.name })
                            }));
