...
class CswStratum extends LoadableStratum(CswCatalogGroupTraits) {
    ...
    static async load(catalogGroup) {
            ...
            if (!domainResponse) {
                throw new TerriaError({
                    ...
                    message: i18next.t("models.csw.checkCORSDomain", {
                        cors: '<a href="http://enable-cors.org/" target="_blank">' +
        ...
        while (paging) {
            ...
            const nextRecord = (_e = json === null || json === void 0 ? void 0 : json.SearchResults) === null || _e === void 0 ? void 0 : _e.nextRecord;
            if (!isDefined(nextRecord) ||
                nextRecord === 0 ||
                nextRecord >= ((_f = json === null || json === void 0 ? void 0 : json.SearchResults) === null || _f === void 0 ? void 0 : _f.numberOfRecordsMatched)) {
                paging = false;
            }
            else {
    ...
    createMetadataGroup(parentId, metadataGroup) {
        ...
        model.setTrait(CommonStrata.underride, "members", filterOutUndefined([
    ...
    createRecord(parentId, record) {
        ...
        if (urlIndex !== -1) {
            ...
            const stratum = CommonStrata.underride;
            model.strata.delete(stratum);
            model.setTrait(stratum, "name", (_b = record.title) !== null && _b !== void 0 ? _b : record.identifier);
            const uri = acceptableUris[urlIndex];
            model.setTrait(stratum, "url", uri.toString());
            if (record.abstract) {
                model.setTrait(stratum, "description", (_c = toArray(record.abstract)) === null || _c === void 0 ? void 0 : _c.join("\n\n"));
            }
            else if (record.description) {
                model.setTrait(stratum, "description", (_d = toArray(record.description)) === null || _d === void 0 ? void 0 : _d.join("\n\n"));
            }
            const infoSections = [];
