            ...
            if (error instanceof RequestErrorEvent &&
                ...
                this.terria.raiseErrorToUser(new TerriaError({
                    message: sdmxErrorString.has(error.statusCode)
                        ...
                        : `${error.response}`,
                    title: `Failed to load SDMX data for "${(_a = this.name) !== null && _a !== void 0 ? _a : this.uniqueId}"`
                }));
            }
            else {
                this.terria.raiseErrorToUser(`Failed to load SDMX data for "${(_b = this.name) !== null && _b !== void 0 ? _b : this.uniqueId}"`);
            }
        }
    }
}
