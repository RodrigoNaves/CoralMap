...
export class SdmxJsonDataflowStratum extends LoadableStratum(SdmxCatalogItemTraits) {
    ...
    get dimensionColumns() {
        ...
        return ((_a = this.sdmxDimensions
            ...
            regionType = this.catalogItem.matchRegionType(modelOverride === null || modelOverride === void 0 ? void 0 : modelOverride.regionType);
            ...
            if (!isDefined(regionType) && (modelOverride === null || modelOverride === void 0 ? void 0 : modelOverride.type) === "region") {
                // Use selectedId of first dimension with one
                regionType = this.catalogItem.matchRegionType((_d = this.getDimensionsWithOverrideType("region-type").find(d => isDefined(d.selectedId))) === null || _d === void 0 ? void 0 : _d.selectedId);
            }
            ...
            if (!isDefined(regionType))
                regionType = (_h = (_g = (_f = (_e = this.catalogItem.matchRegionType(dim.id)) !== null && _e !== void 0 ? _e : this.catalogItem.matchRegionType(codelist === null || codelist === void 0 ? void 0 : codelist.name)) !== null && _f !== void 0 ? _f : this.catalogItem.matchRegionType(codelist === null || codelist === void 0 ? void 0 : codelist.id)) !== null && _g !== void 0 ? _g : this.catalogItem.matchRegionType(concept === null || concept === void 0 ? void 0 : concept.name)) !== null && _h !== void 0 ? _h : this.catalogItem.matchRegionType(concept === null || concept === void 0 ? void 0 : concept.id);
            ...
            if ((modelOverride === null || modelOverride === void 0 ? void 0 : modelOverride.type) === "region") {
                const replacement = (_k = (_j = modelOverride === null || modelOverride === void 0 ? void 0 : modelOverride.regionTypeReplacements) === null || _j === void 0 ? void 0 : _j.find(r => r.find === regionType)) === null || _k === void 0 ? void 0 : _k.replace;
            ...
            return [
                createStratumInstance(TableStyleTraits, {
                    ...
                    chart: this.timeColumns.length > 0 &&
                        ...
                        : undefined,
                    regionColumn: (_a = this.dimensionColumns.find(col => col.type === "region")) === null || _a === void 0 ? void 0 : _a.name
                })
            ];
        }
        return [];
    ...
    get featureInfoTemplate() {
        ...
        const regionType = (_a = this.catalogItem.activeTableStyle.regionColumn) === null || _a === void 0 ? void 0 : _a.regionType;
        if (!regionType)
            return;
        ...
        template += (_c = this.catalogItem.sdmxSelectableDimensions) === null || _c === void 0 ? void 0 : _c.filter(d => (d.name || d.id) && !d.disable && d.selectedId).map(d => {
            var _a, _b;
