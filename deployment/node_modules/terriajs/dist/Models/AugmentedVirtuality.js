...
export default class AugmentedVirtuality {
    constructor(terria) {
        ...
        if ("ondeviceorientation" in window) {
            window.addEventListener("deviceorientation", event => this.storeOrientation(event));
        }
    }
    toggleEnabled() {
        if (this.active) {
    ...
    hover(height, position, flyTo) {
        ...
        const flyToHeight = (surfaceHeight) => {
            height += surfaceHeight;
            const newPosition = CesiumCartesian3.fromRadians(hoverPosition.longitude, hoverPosition.latitude, height);
            const pose = {
        ...
        if (!this.scene ||
            ...
            sampleTerrainMostDetailed(terrainProvider, [hoverPosition]).then(function (updatedPosition) {
     ...
     */
    moveTo(position, maximumHeight, flyTo) {
        ...
        // Reset the viewer height.
        const moveToLocation = (surfaceHeight) => {
            let hoverHeight = viewerHeight - surfaceHeight;
            if (hoverHeight > maximumHeight)
     ...
     */
    startEventLoop(enable) {
        if (this.isEventLoopRunning === enable)
            return;
        if (enable === true) {
            this.orientationUpdated = true;
            const intervalMs = 1000 / this.maximumUpdatesPerSecond;
            const id = setInterval(() => runInAction(() => this.updateOrientation()), intervalMs);
    ...
    getCurrentOrientation(screenOrientation) {
        ...
        return computeTerriaOrientation(alpha, beta, gamma, screenOrientation, realignAlpha, realignHeading);
    }
}
/**
...
__decorate([
    observable
], AugmentedVirtuality.prototype, "eventLoopState", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "orientationUpdated", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "alpha", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "beta", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "gamma", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "realignAlpha", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "realignHeading", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "lastScreenOrientation", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "maximumUpdatesPerSecond", void 0);
__decorate([
    observable
], AugmentedVirtuality.prototype, "hoverLevel", void 0);
__decorate([
    computed
], AugmentedVirtuality.prototype, "scene", null);
__decorate([
    computed
], AugmentedVirtuality.prototype, "camera", null);
__decorate([
    computed
], AugmentedVirtuality.prototype, "active", null);
__decorate([
    action
], AugmentedVirtuality.prototype, "activate", null);
__decorate([
    action
], AugmentedVirtuality.prototype, "deactivate", null);
__decorate([
    action
], AugmentedVirtuality.prototype, "toggleManualAlignment", null);
__decorate([
    computed
], AugmentedVirtuality.prototype, "manualAlignmentSet", null);
__decorate([
    computed
], AugmentedVirtuality.prototype, "isEventLoopRunning", null);
__decorate([
    action
], AugmentedVirtuality.prototype, "toggleHoverHeight", null);
 ...
 */
function computeTerriaOrientation(alpha, beta, gamma, screenOrientation, realignAlpha, realignHeading) {
    ...
    const getColumn = (mat, col) => {
        return mat[col];
    };
    // Simplify notation for readability:
    const r10 = getColumn(rotation, CesiumMatrix3.COLUMN1ROW0);
    const r11 = getColumn(rotation, CesiumMatrix3.COLUMN1ROW1);
    const r02 = getColumn(rotation, CesiumMatrix3.COLUMN0ROW2);
    const r12 = getColumn(rotation, CesiumMatrix3.COLUMN1ROW2);
    const r22 = getColumn(rotation, CesiumMatrix3.COLUMN2ROW2);
...
//# sourceMappingURL=AugmentedVirtuality.js.map