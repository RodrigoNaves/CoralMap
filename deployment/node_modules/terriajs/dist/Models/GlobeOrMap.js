    ...
    async _highlightFeature(feature) {
        ...
        if (isDefined(feature)) {
            ...
            if (!hasGeometry) {
                if (feature.imageryLayer &&
                ...
                else if (!isDefined(this.supportsPolylinesOnTerrain) ||
                    ...
                    if (geoJson &&
                        ...
                        const catalogItem = new GeoJsonCatalogItem(GlobeOrMap._featureHighlightName, this.terria);
                        catalogItem.setTrait(CommonStrata.user, "name", GlobeOrMap._featureHighlightName);
