...
function CatalogMemberMixin(Base) {
    class CatalogMemberMixin extends AccessControlMixin(Base) {
         ...
         */
        async loadMetadata() {
            return (await this._metadataLoader.load()).clone(`Failed to load \`${getName(this)}\` metadata`);
        }
        /**
...
export const getName = action((model) => {
    var _a, _b;
    return ((_b = (_a = (CatalogMemberMixin.isMixedInto(model) ? model.name : undefined)) !== null && _a !== void 0 ? _a : model === null || model === void 0 ? void 0 : model.uniqueId) !== null && _b !== void 0 ? _b : "Unknown model");
});
