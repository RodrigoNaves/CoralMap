...
function ReferenceMixin(Base) {
    class ReferenceMixin extends Base {
        constructor() {
            super(...arguments);
            this._referenceLoader = new AsyncLoader(() => {
                ...
                return this.forceLoadReference(previousTarget).then(target => {
                    if (target &&
                        ...
                        throw new DeveloperError("The model returned by `forceLoadReference` must be constructed " +
    ...
    __decorate([
        observable
    ], ReferenceMixin.prototype, "_target", void 0);
    return ReferenceMixin;
}
ReferenceMixin.isMixedInto = function (model) {
