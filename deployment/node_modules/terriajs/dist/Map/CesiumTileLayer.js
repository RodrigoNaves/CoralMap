...
__decorate([
    observable
], CesiumTileLayer.prototype, "splitDirection", void 0);
__decorate([
    observable
], CesiumTileLayer.prototype, "splitPosition", void 0);
__decorate([
    computed
], CesiumTileLayer.prototype, "_clipsForSplitter", null);
function getCreditHtml(credit) {
    return credit.element.outerHTML;
}
//# sourceMappingURL=CesiumTileLayer.js.map