    ...
    this._loadRegionNamesPromise = loadText(url).then(function (xml) {
        ...
        if (!defined(obj.member)) {
            ...
            throw new TerriaError({
                ...
                message: "Couldn't load region names for region type " +
                    that.regionType +
                    exception
            });
        }
        ...
        if (obj.member.length === 1 && !defined(obj.member[0])) {
            throw new TerriaError({
                ...
                message: i18next.t("map.regionProvider.csvRegionMappingMessageZeroFound", { regionType: that.regionType })
            });
        }
 ...
 */
RegionProvider.prototype.mapRegionsToIndicesInto = function (regionArray, disambigValues, failedMatches, ambiguousMatches, timeIntervals, time) {
...
function loadRegionsFromWfs(regionProvider, propName) {
    ...
    return loadText(url).then(function (xml) {
        ...
        if (!defined(obj.member)) {
            ...
            throw new TerriaError({
                title: i18next.t("map.regionProvider.csvRegionMappingTitle"),
                message: i18next.t("map.regionProvider.csvRegionMappingMessageLoadError", { regionName: propName, exception: exception })
            });
        }
        if (!(obj.member instanceof Array)) {
            obj.member = [obj.member];
        ...
        if (obj.member.length === 1 && !defined(obj.member[0])) {
            throw new TerriaError({
                title: i18next.t("map.regionProvider.csvRegionMappingTitle"),
                message: i18next.t("map.regionProvider.csvRegionMappingMessageZeroBoundariesFound", { regionName: propName })
            });
        }
        return {
    ...
    values.forEach(function (value, index) {
        ...
        if (!isDisambiguation) {
            if (!defined(regionProvider._idIndex[value])) {
                ...
                if (typeof regionProvider._idIndex[value] ===
...
function findRegionIndex(regionProvider, code, disambigCode) {
    ...
    if (!defined(id)) {
        ...
        for (var i = 0; i < ids.length; i++) {
            if (regionProvider.regions[ids[i]][regionProvider.disambigProp] ===
