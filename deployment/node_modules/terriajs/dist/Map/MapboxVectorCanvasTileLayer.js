...
export default class MapboxVectorCanvasTileLayer extends L.GridLayer {
    ...
    createTile(tilePoint, done) {
        ...
        this.imageryProvider.readyPromise
            ...
            return this.imageryProvider._requestImage(CesiumMath.mod(tilePoint.x, n), tilePoint.y, tilePoint.z, canvas);
        })
...
__decorate([
    observable
], MapboxVectorCanvasTileLayer.prototype, "splitDirection", void 0);
__decorate([
    observable
], MapboxVectorCanvasTileLayer.prototype, "splitPosition", void 0);
__decorate([
    computed
], MapboxVectorCanvasTileLayer.prototype, "_clipsForSplitter", null);
//# sourceMappingURL=MapboxVectorCanvasTileLayer.js.map