...
export default class ArcGisPortalCatalogGroupTraits extends mixTraits(GroupTraits, UrlTraits, CatalogMemberTraits, ArcGisPortalSharedTraits) {
    constructor() {
        super(...arguments);
        this.searchParams = {
...
], ArcGisPortalCatalogGroupTraits.prototype, "blacklist", void 0);
__decorate([
    anyTrait({
