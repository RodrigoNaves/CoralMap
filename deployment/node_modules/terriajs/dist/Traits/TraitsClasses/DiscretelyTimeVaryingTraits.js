...
export default class DiscretelyTimeVaryingTraits extends mixTraits(TimeVaryingTraits, MappableTraits) {
    constructor() {
        super(...arguments);
...
], DiscretelyTimeVaryingTraits.prototype, "chartType", void 0);
__decorate([
    primitiveTrait({
        type: "string",
...
], DiscretelyTimeVaryingTraits.prototype, "chartDisclaimer", void 0);
__decorate([
    primitiveTrait({
        type: "string",
        name: "Chart color",
...
], DiscretelyTimeVaryingTraits.prototype, "chartColor", void 0);
__decorate([
    primitiveTrait({
        type: "boolean",
