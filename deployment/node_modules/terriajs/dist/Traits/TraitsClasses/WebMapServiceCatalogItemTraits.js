...
let WebMapServiceCatalogItemTraits = class WebMapServiceCatalogItemTraits extends mixTraits(ExportableTraits, DiffableTraits, FeatureInfoTraits, LayerOrderingTraits, TimeFilterTraits, GetCapabilitiesTraits, RasterLayerTraits, UrlTraits, MappableTraits, CatalogMemberTraits) {
    constructor() {
        super(...arguments);
        this.tileWidth = 256;
        this.tileHeight = 256;
...
], WebMapServiceCatalogItemTraits.prototype, "minScaleDenominator", void 0);
__decorate([
    primitiveTrait({
        type: "boolean",
...
], WebMapServiceCatalogItemTraits.prototype, "hideLayerAfterMinScaleDenominator", void 0);
__decorate([
    primitiveTrait({
        type: "number",
...
], WebMapServiceCatalogItemTraits.prototype, "linkedWcsUrl", void 0);
__decorate([
    primitiveTrait({
        type: "string",
...
], WebMapServiceCatalogItemTraits.prototype, "linkedWcsCoverage", void 0);
__decorate([
    primitiveTrait({
        type: "string",
        name: "Is GeoServer",
