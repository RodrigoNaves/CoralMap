...
export default class ArcGisMapServerCatalogItemTraits extends mixTraits(MappableTraits, FeatureInfoTraits, RasterLayerTraits, LayerOrderingTraits, MappableTraits, UrlTraits, CatalogMemberTraits, DiscretelyTimeVaryingTraits) {
    constructor() {
        super(...arguments);
...
], ArcGisMapServerCatalogItemTraits.prototype, "maximumScaleBeforeMessage", void 0);
__decorate([
    primitiveTrait({
        name: "Show tiles after message",
        description: "Value indicating whether to continue showing tiles when the `maximumScaleBeforeMessage` is exceeded.",
        type: "boolean"
    })
], ArcGisMapServerCatalogItemTraits.prototype, "showTilesAfterMessage", void 0);
__decorate([
    primitiveTrait({
        name: "Token URL",
