...
export default class CkanCatalogGroupTraits extends mixTraits(GroupTraits, UrlTraits, CatalogMemberTraits, CkanSharedTraits) {
    constructor() {
        super(...arguments);
        this.filterQuery = [
            {
...
], CkanCatalogGroupTraits.prototype, "blacklist", void 0);
__decorate([
    anyTrait({
        name: "Filter Query",
