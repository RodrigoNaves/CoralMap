        ...
        return (React.createElement(StyledMapNavigation, { trainerBarVisible: viewState.trainerBarVisible },
            React.createElement(Box, { centered: true, column: true, justifySpaceBetween: true, fullHeight: true, alignItemsFlexEnd: true, ref: this.navigationRef },
              ...
              ${this.orientation === Orientation.HORIZONTAL &&
                        `margin-bottom: 5px;`}
            ` },
                    items.map(item => (React.createElement(MapNavigationItem, { key: item.id, item: item, terria: terria }))),
                ...
                React.createElement(ControlWrapper, { column: this.orientation === Orientation.VERTICAL }, bottomItems === null || bottomItems === void 0 ? void 0 :
                    bottomItems.map(item => (React.createElement(MapNavigationItem, { key: item.id, item: item, terria: terria }))),
                    React.createElement(Medium, null,
                        React.createElement(Prompt, { content: React.createElement("div", null,
                                ...
                                runInAction(() => viewState.toggleFeaturePrompt("help", false, true));
                            }, caretTopOffset: 75, caretLeftOffset: 265, caretSize: 15, promptWidth: 273, promptTopOffset: 20, promptLeftOffset: -330, isVisible: viewState.featurePrompts.indexOf("help") >= 0 }))))));
    }
};
