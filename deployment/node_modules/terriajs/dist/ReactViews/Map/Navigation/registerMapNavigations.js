...
import { FeedbackButtonController, FEEDBACK_TOOL_ID } from "../../Feedback/FeedbackButtonController";
import PedestrianMode, { PEDESTRIAN_MODE_ID } from "../../Tools/PedestrianMode/PedestrianMode";
import { ToolButtonController } from "../../Tools/Tool";
import { HELP_PANEL_ID } from "../Panels/HelpPanel/HelpPanel";
import { AR_TOOL_ID, AugmentedVirtualityController, AugmentedVirtualityHoverController, AugmentedVirtualityRealign, AugmentedVirtualityRealignController } from "./Items/AugmentedVirtualityTool";
...
export const registerMapNavigations = (viewState) => {
    ...
    mapNavigationModel.addItem({
        ...
        order: 2,
        screenSize: "medium",
        render: React.createElement(ZoomControl, { terria: terria })
    });
    ...
    mapNavigationModel.addItem({
        ...
        title: runInAction(() => toggleSplitterController.disabled
    ...
    const pedestrianModeToolController = new ToolButtonController({
        ...
        viewState: viewState,
        getToolComponent: () => PedestrianMode,
    ...
    mapNavigationModel.addItem({
        ...
        render: React.createElement(CloseToolButton, { viewState: viewState }),
        order: 7
    });
    ...
    mapNavigationModel.addItem({
        ...
        name: runInAction(() => augmentedVirtuality.manualAlignmentSet
            ? "translate#AR.btnRealign"
            : "translate#AR.btnResetRealign"),
        location: "TOP",
        screenSize: "small",
        controller: arRealignController,
        render: (React.createElement(AugmentedVirtualityRealign, { arRealignController: arRealignController })),
        order: 1,
        noExpand: true
    });
...
//# sourceMappingURL=registerMapNavigations.js.map