...
let MapNavigationItem = class MapNavigationItem extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Control, { ref: item.controller.itemRef },
            React.createElement(MapIconButton, { expandInPlace: true, noExpand: item.noExpand, iconElement: () => React.createElement(Icon, { glyph: item.controller.glyph }), title: useTranslationIfExists(item.title || item.name), onClick: () => {
