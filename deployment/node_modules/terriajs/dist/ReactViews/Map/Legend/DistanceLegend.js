...
let DistanceLegend = class DistanceLegend extends React.Component {
    constructor() {
        super();
        this.state = {
    ...
    UNSAFE_componentWillMount() {
        ...
        this.viewerSubscriptions.push(this.props.terria.mainViewer.beforeViewerChanged.addEventListener(() => {
    ...
    render() {
        ...
        const distanceLabel = this.state.distanceLabel ? (React.createElement("div", { className: Styles.distanceLegend },
            React.createElement("label", null, this.state.distanceLabel),
            React.createElement("div", { className: Styles.bar, style: barStyle }))) : null;
        return distanceLabel;
    }
};
DistanceLegend.displayName = "DistanceLegend";
DistanceLegend.propTypes = {
    terria: PropTypes.object
};
DistanceLegend = __decorate([
    observer
], DistanceLegend);
module.exports = DistanceLegend;
//# sourceMappingURL=DistanceLegend.js.map