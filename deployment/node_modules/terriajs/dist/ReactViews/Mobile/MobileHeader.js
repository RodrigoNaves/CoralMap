        ...
        return (React.createElement("div", { className: Styles.ui },
            React.createElement(Box, { justifySpaceBetween: true, fullWidth: true, fullHeight: true, paddedRatio: 1, backgroundColor: this.props.theme.dark },
                React.createElement(Choose, null,
                    ...
                    left: 5px;
                  ` },
                            React.createElement(RawButton, { type: "button", onClick: () => this.props.viewState.toggleMobileMenu(), title: t("mobile.toggleNavigation"), css: `
                      border-radius: 2px;
                      padding: 0 5px;
                      margin-right: 3px;
                      &:hover,
                    ...
                    ` },
                                React.createElement(StyledIcon, { light: true, glyph: Icon.GLYPHS.menu, styledWidth: "37px", styledHeight: "37px" })),
                  ...
                  ` },
                            React.createElement("button", { type: "button", className: Styles.btnAdd, onClick: this.onMobileDataCatalogClicked },
                                ...
                                React.createElement(Icon, { glyph: Icon.GLYPHS.increase })),
                            ...
                            React.createElement("button", { className: Styles.btnSearch, type: "button", onClick: this.showSearch },
                                React.createElement(Icon, { glyph: Icon.GLYPHS.search })))),
            ...
            React.createElement(MobileModalWindow, { terria: this.props.terria, viewState: this.props.viewState })));
    }
}));
