...
export default (props) => {
    ...
    let brandingHtmlElements = (_a = props.terria.configParameters.brandBarElements) !== null && _a !== void 0 ? _a : [
        DEFAULT_BRANDING
    ];
    ...
    return (React.createElement("div", { css: `
      ...
      ` }, brandingHtmlElements.map((element, idx) => (React.createElement(React.Fragment, { key: idx }, parseCustomHtmlToReact(element.replace(/\{\{\s*version\s*\}\}/g, version)))))));
};
