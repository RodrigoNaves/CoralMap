...
const ViewingControls = observer(createReactClass({
    ...
    renderViewingControlsMenu() {
        ...
        return (React.createElement("ul", { ref: e => (this.menuRef = e) },
            ...
            React.createElement(If, { condition: ExportableMixin.isMixedInto(item) && item.canExportData },
                React.createElement("li", null,
            ...
            React.createElement(If, { condition: SearchableItemMixin.isMixedInto(item) && item.canSearch },
                React.createElement("li", null,
