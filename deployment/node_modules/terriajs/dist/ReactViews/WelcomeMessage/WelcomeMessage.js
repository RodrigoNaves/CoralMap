        ...
        React.createElement(WelcomeModalWrapper, { fullWidth: true, fullHeight: true, position: "absolute", right: true, onClick: () => handleClose(false) },
            React.createElement(Box, { styledWidth: viewState.isMapFullScreen || viewState.useSmallScreenInterface
                ...
                React.createElement(SlideUpFadeIn, { isVisible: welcomeVisible },
                    React.createElement(Box, { styledWidth: "667px", styledMinHeight: "504px", displayInlineBlock: true, paddedRatio: 6, onClick: e => {
                ...
                ` },
                        ...
                        React.createElement(Box, { displayInlineBlock: true, col10: true },
                            React.createElement(Text, { bold: true, textLight: true, styledFontSize: "36px", styledLineHeight: "49px" }, t("welcomeMessage.title")),
                            React.createElement(Spacing, { bottom: 3 }),
                            React.createElement(Text, { textLight: true, medium: true },
                                React.createElement(Trans, { i18nKey: "welcomeMessage.welcomeMessage" },
                        ...
                        ` }))),
                            ...
                            React.createElement(Box, { styledWidth: viewState.useSmallScreenInterface ? "100%" : "37%", displayInlineBlock: true },
                                React.createElement(If, { condition: !viewState.useSmallScreenInterface },
