...
let Tooltip = class Tooltip extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(CSSTransition, { in: show, classNames: { ...Styles }, timeout: 1000, unmountOnExit: true },
            React.createElement(VxTooltip, { className: Styles.tooltip, key: Math.random(), style: this.style },
