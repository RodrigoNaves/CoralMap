    ...
    render() {
        ...
        if (items.length > 0) {
            ...
            Promise.all(items
                ...
                .map(item => item.loadMapItems())).then(results => Result.combine(results, "Failed to load chart items").raiseError(this.props.terria));
                ...
                React.createElement("div", { className: Styles.chartPanel, style: { height: height } },
                    React.createElement("div", { className: Styles.body },
                        React.createElement("div", { className: Styles.header },
                            ...
                            React.createElement(ChartPanelDownloadButton, { chartableItems: chartItems }),
