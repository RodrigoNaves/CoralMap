...
export default class TableAutomaticStylesStratum extends LoadableStratum(TableTraits) {
    ...
    get styles() {
        ...
        if (columns.length === 0) {
            columns = this.catalogItem.tableColumns.filter(column => column.type === TableColumnType.text);
        }
...
export class ColorStyleLegend extends LoadableStratum(LegendTraits) {
    ...
    get title() {
        if (this.catalogItem.activeTableStyle.colorMap instanceof DiscreteColorMap ||
    ...
    get items() {
        ...
        if (colorMap instanceof DiscreteColorMap) {
            ...
            return this._createLegendItemsFromContinuousColorMap(activeStyle, colorMap);
        }
    ...
    get numberFormatOptions() {
        var _a, _b, _c, _d;
        const colorColumn = (_b = (_a = this.catalogItem) === null || _a === void 0 ? void 0 : _a.activeTableStyle) === null || _b === void 0 ? void 0 : _b.colorColumn;
        if ((_c = colorColumn === null || colorColumn === void 0 ? void 0 : colorColumn.traits) === null || _c === void 0 ? void 0 : _c.format)
            return (_d = colorColumn === null || colorColumn === void 0 ? void 0 : colorColumn.traits) === null || _d === void 0 ? void 0 : _d.format;
        if (colorColumn &&
    ...
    _createLegendItemsFromContinuousColorMap(activeStyle, colorMap) {
        ...
        return new Array(7)
            .fill(0)
            .map((_, i) => {
            const value = colorMap.minValue + (colorMap.maxValue - colorMap.minValue) * (i / 6);
    ...
    _createLegendItemsFromDiscreteColorMap(activeStyle, colorMap) {
        const colorColumn = activeStyle.colorColumn;
    ...
    _createLegendItemsFromEnumColorMap(activeStyle, colorMap) {
        const colorColumn = activeStyle.colorColumn;
    ...
    _createLegendItemsFromConstantColorMap(activeStyle, colorMap) {
        return [
            createStratumInstance(LegendItemTraits, {
