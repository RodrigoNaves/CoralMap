...
export default class TableColumn {
    ...
    get valuesAsRegions() {
        ...
        for (let i = 0; i < values.length; ++i) {
            const value = values[i];
            const regionId = this.findMatchingRegion(regionType, value);
    ...
    findMatchingRegion(regionType, rowValue) {
        ...
        return rowValue.length > 0
            ? (_a = applyReplacements(regionType, rowValue, "dataReplacements")) !== null && _a !== void 0 ? _a : null : null;
    }
    /**
    ...
    get title() {
        var _a, _b;
        return ((_b = (_a = this.tableModel.columnTitles[this.columnNumber]) !== null && _a !== void 0 ? _a : this.traits.title) !== null && _b !== void 0 ? _b : this.name);
    }
    get units() {
